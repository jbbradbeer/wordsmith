...
export const SEED_WORDS = [
  ...
  "suffer",
  // Weekly SEO loop 2026-08-17 (25 words from backlog)
  "test", "view", "handsome", "ideal", "argue", "break", "close", "damage",
  "deal", "disappear", "face", "fix", "interact", "interpret", "limit", "list",
  "measure", "persuade", "practice", "prohibit", "react", "release", "rely", "remind",
  "restore",
  // Weekly SEO loop 2026-08-24 (25 words from backlog)
  "hidden", "elevate", "eliminate", "finish", "gain", "justify", "neglect", "possess",
  "reject", "command", "contain", "entertain", "modify", "object", "retain", "delicate",
  "tolerate", "verify", "approve", "remain", "grand", "helpless", "keen", "happen",
  "hesitate",
  // Weekly SEO loop 2026-08-31 (25 words from backlog)
  "imitate", "punish", "foolish", "lavish", "anticipate", "donate", "frighten", "incorporate",
  ...
  "force",
  // Weekly SEO loop 2026-09-14 (25 words from backlog)
  "insult", "lack", "nurture", "oppose", "scold", "travel", "whisper", "yell",
  "attract", "beg", "burn", "compete", "consist", "declare", "disturb", "divide",
  "gaze", "guarantee", "handle", "harm", "imagine", "judge", "matter", "push",
  "recall",
  // Weekly SEO loop 2026-09-21 (25 words from backlog)
  "shout", "cunning", "eerie", "enchanting", "firm", "surrender", "trick", "yield",
